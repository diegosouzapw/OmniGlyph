...
OmniGlyph లేకుండా నడిచిన సెషన్ యొక్క పూర్తి ప్రిఫిక్స్ Anthropic వద్ద టెక్స్ట్‌గా 0.1× రీడ్ రేటుతో కేష్ అయి ఉంటుంది; చిత్రాలతో వచ్చే మొదటి అభ్యర్థన అదంతా ఒకే ప్రాంప్ట్‌లో 1.25× రేటుతో కొత్త కేష్-రైట్‌గా మళ్లీ చెల్లించేలా చేసేది. ప్రాక్సీ దీన్నుంచి కాపాడుతుంది: అది ఎప్పుడూ చిత్రాలుగా మార్చని సెషన్ యొక్క ఈ ఒక్కసారి ఖర్చును బ్రేక్-ఈవెన్ గేట్‌లో లెక్కించి, ఇంకా లాభదాయకమైతేనే చిత్రాలకు మారుతుంది — లేకపోతే సెషన్ టెక్స్ట్‌గానే ఉంటుంది, పొదుపు మీ తదుపరి కొత్త సెషన్ నుంచి మొదలవుతుంది.

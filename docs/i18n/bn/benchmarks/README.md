...
## সাশ্রয় কীভাবে কাজ করে (এক ছবিতে)

প্রোভাইডাররা **টেক্সট বিল করে টোকেন অনুযায়ী**, কিন্তু **ইমেজ বিল করে তার
মাত্রা অনুযায়ী** — এতে কত টেক্সট গাদাগাদি করে ভরা আছে তা দিয়ে নয়। একটি
স্ট্যান্ডার্ড পৃষ্ঠা একটি ফ্ল্যাট খরচ, ভেতরে টেক্সট যতই ঘন হোক না কেন:
...
কেন ইমেজ জেতে — প্রতি টোকেনে বহন করা ক্যারেক্টার:
...
OmniGlyph এই অদল-বদল তখনই করে যখন এক্সাক্ট গণিত বলে এটি জেতে, এবং শুধুমাত্র
সেই মডেলগুলোর জন্য যারা পৃষ্ঠা পড়তে পারে বলে প্রমাণিত হয়েছে। নিচের দুটি
হার্নেস প্রতিটি অর্ধেক প্রমাণ করে।
...
রিড অ্যাকুরেসি এক নজরে — এটাই fail-closed মডেল গেট, চিত্রিত:
...
শুধুমাত্র ✅ আর্ম শিপ করে। যা কিছু খারাপ পড়ে তা *রসিদসহ* ব্লক করা হয়, এবং
থ্রি-ওয়ে স্কোর মানে ভুল অনুমানকারী মডেলকে (`silent_wrong`) সৎভাবে abstain
করা মডেলের (`ILEGIVEL`) চেয়ে খারাপ ধরা হয়।

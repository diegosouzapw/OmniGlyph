...
**সেশনের মাঝপথে চালু করলাম আর খরচ লাফিয়ে বাড়ল — কেন?**
OmniGlyph ছাড়া চলা সেশনের পুরো প্রিফিক্স Anthropic-এ টেক্সট হিসেবে 0.1× রিড রেটে ক্যাশ থাকে; ছবিসহ প্রথম অনুরোধটি এক প্রম্পটেই সেই সবকিছু 1.25× হারে নতুন ক্যাশ-রাইট হিসেবে আবার পরিশোধ করাত। প্রক্সি এর থেকে রক্ষা করে: যে সেশনকে সে কখনো ছবিতে রূপান্তর করেনি, তার এই এককালীন খরচ ব্রেক-ইভেন গেটে যোগ হয় এবং কেবল তখনই ছবিতে যায় যখন এখনো লাভজনক — নাহলে সেশন টেক্সটই থাকে, আর সাশ্রয় শুরু হয় আপনার পরের নতুন সেশন থেকে।

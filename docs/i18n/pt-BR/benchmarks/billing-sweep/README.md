...
**Por que existe:** o gate de rentabilidade só é seguro se a estimativa de
custo for *exata*. Uma fórmula com um pequeno desvio converteria blocos que
na verdade custam mais. Então esse sweep fixa a fórmula aos números reais da
API antes de ir para produção — até **resíduo zero**.

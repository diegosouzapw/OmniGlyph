...
**فعّلته في منتصف الجلسة فقفز الاستهلاك — لماذا؟**
الجلسة التي عملت بدون OmniGlyph تكون بادئتها كاملةً مخزّنة مؤقتًا لدى Anthropic كنص بمعدل قراءة 0.1×؛ وأول طلب بالصور سيعيد دفع كل ذلك ككتابة تخزين مؤقت جديدة بمعدل 1.25× في موجّه واحد. يحمي الوكيل من ذلك: الجلسة التي لم يحوّلها قط إلى صور تُدخل هذه التكلفة لمرة واحدة في بوابة نقطة التعادل، ولا يتحول إلى الصور إلا إذا ظل ذلك مجديًا — وإلا تبقى الجلسة نصًا ويبدأ التوفير مع جلستك الجديدة التالية.

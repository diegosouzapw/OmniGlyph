...
![Обзор: KPI-карточки центра управления, спарклайн экономии и живая лента событий](../../assets/dashboard-overview.png)
...
| Live Flow | Бенчмарки |
|---|---|
| ![Конвейер запроса в виде живого графа узлов](../../assets/dashboard-flow.png) | ![Подтверждающие данные бенчмарков и dry-run прямо в UI](../../assets/dashboard-benchmarks.png) |

![Телеметрия: одометр и живая временная шкала запросов](../../assets/dashboard-telemetry.png)
...
**Я включил его посреди сессии, и расход взлетел — почему?**
...
**Можно ли использовать его без Claude Code — в Cursor, ChatGPT, обычном пайпе?**

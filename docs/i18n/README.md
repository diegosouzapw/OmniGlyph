# 🌐 Multilingual Documentation — OmniGlyph

Translations of the OmniGlyph documentation into 41 languages. Code blocks, CLI flags, and environment variable names remain in English.
...
Each language folder mirrors the repository layout: root documents (README, CHANGELOG, CONTRIBUTING, SECURITY, CODE_OF_CONDUCT, llm.txt) at the top level, plus `docs/` and `benchmarks/` subtrees. The English originals at the repository root are the source of truth.

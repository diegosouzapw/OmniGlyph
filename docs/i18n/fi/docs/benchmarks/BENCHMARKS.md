...
| koe | mitat | Fable 5 (high-res) | Sonnet 4.5 (standard) |
|---|---|---:|---:|
...
### Fable 5 2×2-matriisi — CLI:n/tilauksen kautta, n=30/haara, sama korpus (~16,6k merkkiä)
...
### Opus 4.8 — CLI:n/tilauksen kautta, n=30/haara

| konfiguraatio | tarkka | pidättäytymiset | virheet |
|---|---:|---:|---:|
| high-res · 10×16-solu | **26/30 (87 %)** | 0 | 4 (numerot) |
| standard · 5×8-solu | 0/30 | 30 | 0 |

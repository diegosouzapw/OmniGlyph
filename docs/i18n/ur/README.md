...
**میں نے سیشن کے بیچ میں فعال کیا اور استعمال اچانک بڑھ گیا — کیوں؟**
جو سیشن OmniGlyph کے بغیر چلا ہو، اس کا پورا پری فکس Anthropic کے پاس متن کی صورت میں 0.1× ریڈ ریٹ پر کیش ہوتا ہے؛ تصاویر والی پہلی درخواست یہ سب کچھ ایک ہی پرامپٹ میں 1.25× پر نئی کیش رائٹ کے طور پر دوبارہ ادا کروا دیتی۔ پراکسی اس سے بچاتا ہے: جس سیشن کو اس نے کبھی تصویری نہیں بنایا، اس کی یہ یک بارگی لاگت بریک ایون گیٹ میں شامل کی جاتی ہے اور تصاویر پر تبھی جاتا ہے جب اب بھی فائدہ ہو — ورنہ سیشن متن ہی رہتا ہے اور بچت آپ کے اگلے نئے سیشن سے شروع ہوتی ہے۔

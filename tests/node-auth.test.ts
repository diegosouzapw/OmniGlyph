...
const TMP_PREFIX = 'omniglyph-codex-auth-';
...
const ORIGINAL_CODEX_AUTH_FILE = process.env.OMNIGLYPH_CODEX_AUTH_FILE;
...
afterEach(() => {
  ...
  setOptionalEnv('OMNIGLYPH_CODEX_AUTH_FILE', ORIGINAL_CODEX_AUTH_FILE);
...
describe('resolveOpenAIApiKey', () => {
  ...
  it('wires Codex ChatGPT auth into the Node runtime config', () => {
    ...
    process.env.OMNIGLYPH_CODEX_AUTH_FILE = authFile;
